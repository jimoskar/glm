...
$$
which shows that $T_1 = T_2$ and hence $A$ and $B$ are equivalent.

\textcolor{red}{Do not necessarily need to show that they are equal, only argue why they are equivalent.}
