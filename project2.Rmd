...
For both the linear model and for the gamma-GLM, there is no evidence that we should reject $H_0$, which support the hypothesis that the relationship $y_i = y_0x_{bi}^{3/4}$ holds.
