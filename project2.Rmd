...
$$
We now observe that $A$ is equivalent to $\{T_2 > t_{n'-2, \alpha}\} = \{T_2 > t_{n-p, \alpha}\}$, where $p = 3$ as before. This shows that $A$ and $B$ are equivalent.

\textcolor{red}{I do not use the profile likelihodd though?}
