...
```
\textcolor{red}{Litt usikker på hva slags notasjon vi skal bruke, f. eks. boldface for vektorer eller ikke? Bare si ifra hvis du vil ha noe spesifikit:)}
...
\end{split}
$$
Where in the third equality we have used that the $y_i$'s are independent. The expected Fisher information can also be verified by the relationship
$$
...
# Function using the Fisher scoring algorithm
