...
$$
The corresponding standard errors of these estimators can then be estimated using the delta method. A first order Taylor expansion of $\mu(\beta_0,\beta_1)$ gives \textcolor{red}{Kanskje endre til vektornotasjon her?}
$$
