...
\begin{split}
  ...
  &= \text{E}\left[ \text{exp}\left(\beta_0 + \beta_h x_{ijk} + \gamma_{i}^a + \gamma_{j}^d\right) \right]\\
  &= \text{exp}\left( \beta_0 + \beta_h x_{ijk}\right) \text{E}\left[\exp\left(\gamma_{i}^a + \gamma_{j}^d\right)\right] \\
...
\begin{split}
  ...
  &= \text{E}\left[ \text{exp}\left(\beta_0 + \beta_h x_{ijk} + \gamma_{i}^a + \gamma_{j}^d\right) \right] + \text{Var}\left[ \text{exp}\left(\beta_0 + \beta_h x_{ijk} + \gamma_{i}^a + \gamma_{j}^d\right) \right]\\
  &= \text{E}[y_{ijk}]  + \text{exp}\left( 2(\beta_0 + \beta_h x_{ijk}\right)) \text{Var}\left[ \text{exp}\left(\gamma_{i}^a + \gamma_{j}^d\right) \right]\\
